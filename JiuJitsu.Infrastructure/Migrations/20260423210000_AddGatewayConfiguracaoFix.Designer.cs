...
namespace JiuJitsu.Infrastructure.Migrations
{
    ...
    [Migration("20260423210000_AddGatewayConfiguracaoFix")]
    partial class AddGatewayConfiguracaoFix
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("JiuJitsu.Domain.Entities.ConfiguracaoGlobal", b =>
                {
                    ...
                    b.Property<int>("DiasLembreteAposVencimento")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(1)
                        .HasColumnName("dias_lembrete_apos_vencimento");

                    b.Property<string>("GatewayTipo")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(20)
                        .HasColumnType("character varying(20)")
                    ...
                    b.Property<bool>("GerarCobrancaOnlineAutomatico")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
                    ...
                    b.Property<bool>("LembreteInadimplenciaAtivo")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(true)
